	...
	?>
					...
					<div class="form-group"><!--form-group Start-->
						...
						<div class="col-md-6">
							...
							<br>
							<img src="product_images/<?php echo $p_image1;?>" class="img-responsive" width="80" height="80"> 
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<br>
							<img src="product_images/<?php echo $p_image2;?>" class="img-responsive" width="80" height="80">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							...
							<br>
							<img src="product_images/<?php echo $p_image3;?>" class="img-responsive" width="80" height="80">
					...
					<div class="form-group"><!--form-group Start-->
						...
						<div class="col-md-6">
							<textarea name="product_desc" class="form-control" rows="6" cols="19" required="">
								<?php echo $p_desc?>
							</textarea>
						</div>
					</div><!--form-group End-->
